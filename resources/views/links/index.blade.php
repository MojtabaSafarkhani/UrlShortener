            ...
            <table class="table table-bordered table-striped table-hover  align-middle text-center table-dark">
                ...
                @foreach($links as $key=> $link)
                    <tr>
                        ...
                        <td>
                            <input id="copyInput{{$link->id}}" class="mb-1" type="text"
                                   value="http://127.0.0.1:8000/{{$link->slug}}">
                            <button class="btn btn-success" type="button" onclick="copy({{$link->id}});">Copy</button>
                        </td>
                        <td>
